...
if S.MoveLever
    sma = AddState(sma, 'Name', 'WaitBeforeLever', ... %wait duration before the lever is moved in
        ...
        'OutputActions', {});
    if S.LeverWait
        movelever_cond = {'Tup','exit','TouchShaker1_14','WaitForLever'};
    elseif sum(strcmp(sma.StateNames,'AutoReward'))
        movelever_cond = {'Tup','exit','TouchShaker1_14','AutoReward'};
    else
        movelever_cond = {'Tup','exit','TouchShaker1_14','PlayStimulus'};
    end
